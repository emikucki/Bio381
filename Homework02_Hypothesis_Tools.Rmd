...
4. **Mock data**: Here I used a hypothetical graph to show what some potential results could be for my winter warming experiment. One line shows an individual who did not adapt under winter warming (increased metabolic rate at time of warming) and one that did (consistently low m.r. at time of warming). Such data would be interesting because it would suggest plasticity of certain traits at the individual-level, maybe even different rates of adaptation for different populations... 
